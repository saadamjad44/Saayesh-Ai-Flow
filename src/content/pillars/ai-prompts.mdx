...
These are illustrative starting points, not templates to use unchanged. The context is the part you have to supply, and it is the part that makes the difference.
...
The flagging instruction matters more than it looks. Without it, gaps in your notes get quietly filled in with invented detail. [AI writing tools](/ai-writing-tools/) covers how the tools themselves differ for this kind of work.
...
That last sentence is there because helpfully invented extras are common. [AI business and productivity tools](/ai-business-tools/) covers the software side of this work.
...
A Prompt Library is planned, collecting prompts by task so you can adapt a working starting point rather than build one from nothing. It is not published yet, and we would rather leave a gap here than fill it with prompts nobody has put to real use. Deeper guides on individual prompting techniques are planned for this hub too. How we research and label what we publish is set out on our [about and editorial process](/about/) page.
